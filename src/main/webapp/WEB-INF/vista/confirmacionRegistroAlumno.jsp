...
<body>
	...
	El alumno con nombre <strong>${elAlumno.nombre}</strong> , apellido <strong>${elAlumno.apellido}</strong> y edad <strong>${elAlumno.edad}</strong> se ha registrado con éxito.<br/>
